...
//	private LambdaClient awsLambda;
	...
	private String bucketName = "demo-jsh3990-bucket";
...
//                .build();
	...
	public void deleteBucketObjects(String bucket_obj_name /*필요에 따라 컨트롤러에서 매개변수를 받음*/) {
        ...
        ArrayList<ObjectIdentifier> key = new ArrayList<>();
        ObjectIdentifier objId;
        Delete del;

        objId = ObjectIdentifier.builder()
                .key(bucket_obj_name)
                .build();
        ...
        try {
            ...
            System.out.println(bucket_obj_name + " 삭제 완료!");
...
//				.build();
        ...
        //실행시킬 람다 함수명
		String functionName = "demo-api-root";
